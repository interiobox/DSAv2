  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 font-mono uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        draft: "border-transparent bg-slate-200 text-slate-800",
        in_review: "border-transparent bg-amber-100 text-amber-800",
        approved: "border-transparent bg-emerald-100 text-emerald-800",
        issued: "border-transparent bg-primary text-primary-foreground",
        superseded: "border-transparent bg-rose-100 text-rose-800",
      },
    },
    defaultVariants: {
      variant: "default",

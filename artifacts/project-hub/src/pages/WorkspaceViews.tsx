...
export function Projects() {
  ...
  return (
    <div className="flex h-full flex-1 flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-4 sm:p-6"><div className="mx-auto max-w-6xl space-y-5">
...
export function Activity() {
  ...
  return <div className="flex h-full flex-1 flex-col overflow-hidden">
    ...
    <div className="flex-1 overflow-auto p-4 sm:p-6"><div className="mx-auto max-w-5xl space-y-5">

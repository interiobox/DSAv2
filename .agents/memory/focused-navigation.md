...
**How to apply:** Preserve all routes and search access in the direct sidebar, keep admin-only routes conditional, and avoid adding duplicate dashboard shortcuts for destinations already present in the primary shell.